...
class Marksheet5
{
	...
	e=sc.nextInt();
	System.out.print("marks in s6 ");
	h=sc.nextInt();
	
	f=a+b+c+d+e+h;
	g=f/6;
		
	if(a<=100 && b<=100 && c<=100 && d<=100 && e<=100 && h<=100)
	{
		if (a>=35&& b>=35&& c>=35&& d>=35&& e>=35&& h>=35)
		{
		...
		System.out.println("total pesentage is "+g+"%");
			...
			System.out.println("your grade is \n C");			
				...
				else
				{
					...
					if(h<=35)
					{
					System.out.println("you are failed in s6");
					count=count+1;
					}
